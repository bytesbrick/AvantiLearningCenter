...
<html>
<head>
<title>Avanti Learning Centres | Pedagogy</title>
<?php
...
<script language="javascript" type="text/javascript">
	var pageName = "pedagogy";
	document.getElementById("nav-main").getElementsByTagName("li")[1].getElementsByTagName("a")[0].className = "activeitem";
</script>
</body>
</html>
