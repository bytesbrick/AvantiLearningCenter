...
function filter_querystring($query_string, $arrFields, $arrValues){
	...
	$selectWhereClause = "";
	$pageParam="";
	$sqlCount = $db->query("query","select count(alm.unique_id) as 'total' from avn_centermanager_master alm");
	$recCount = $sqlCount[0]['total'];
	$noOfpage = ceil($recCount/$recPerpage);
	$limitStart = ($curPage - 1) * $recPerpage;
	$limitEnd = $recPerpage;
?>
<table cellspacing="1" width="100%" cellpadding="3" id="tabManager" border="0" style="background-color:#f5f5f5;" class="mdata">
	<thead>
	...
	<?php
            if($field == "alm.center_manager_id"){
                if($sort == "asc"){
    ?>
                    <th><a href="javascript:void(0);" onclick="javascript: _getManagerTable (<?php echo $curPage; ?>, 'alm.center_manager_id','desc');" class="sort">Manager ID <img src="./images/up-arr.png" border="0" /></a></th>
    <?php
                }else{
    ?>
                    <th><a href="javascript:void(0);" onclick="javascript: _getManagerTable (<?php echo $curPage; ?>, 'alm.center_manager_id','asc');" class="sort">Manager ID <img src="./images/down-arr.png" border="0" /></a></th>
    <?php
                }
            }else{
    ?>
                    <th><a href="javascript:void(0);" onclick="javascript: _getManagerTable (<?php echo $curPage; ?>, 'alm.center_manager_id','asc');" class="sort">Manager ID</a></th>
	<?php
		}
            if($field == "alm.fname"){
                if($sort == "asc"){
	...
	<?php
            ...
            if($field == "alm.email_id"){
                if($sort == "asc"){
    ?>
                    <th><a href="javascript:void(0);" onclick="javascript: _getManagerTable (<?php echo $curPage; ?>, 'alm.email_id','desc');" class="sort">Email <img src="./images/up-arr.png" border="0" /></a></th>
    <?php
                }else{
    ?>
                    <th><a href="javascript:void(0);" onclick="javascript: _getManagerTable (<?php echo $curPage; ?>, 'alm.email_id','asc');" class="sort">Email <img src="./images/down-arr.png" border="0" /></a></th>
    <?php
                }
            }else{
    ?>
                    <th><a href="javascript:void(0);" onclick="javascript: _getManagerTable (<?php echo $curPage; ?>, 'alm.email_id','asc');" class="sort">Email</a></th>
	<?php
		}
	if($field == "alm.city_name"){
                if($sort == "asc"){
    ?>
                    <th><a href="javascript:void(0);" onclick="javascript: _getManagerTable (<?php echo $curPage; ?>, 'alm.city_name','desc');" class="sort">City Name <img src="./images/up-arr.png" border="0" /></a></th>
    <?php
                }else{
    ?>
                    <th><a href="javascript:void(0);" onclick="javascript: _getManagerTable (<?php echo $curPage; ?>, 'alm.city_name','asc');" class="sort">City Name <img src="./images/down-arr.png" border="0" /></a></th>
    <?php
                }
            }else{
    ?>
                    <th><a href="javascript:void(0);" onclick="javascript: _getManagerTable (<?php echo $curPage; ?>, 'alm.city_name','asc');" class="sort">City Name</a></th>
	<?php
		}
	if($field == "alm.phone"){
                if($sort == "asc"){
    ?>
                    <th><a href="javascript:void(0);" onclick="javascript: _getManagerTable (<?php echo $curPage; ?>, 'alm.phone','desc');" class="sort">Phone <img src="./images/up-arr.png" border="0" /></a></th>
    <?php
                }else{
    ?>
                    <th><a href="javascript:void(0);" onclick="javascript: _getManagerTable (<?php echo $curPage; ?>, 'alm.phone','asc');" class="sort">Phone <img src="./images/down-arr.png" border="0" /></a></th>
    <?php
                }
            }else{
    ?>
   ...
   <?php
	$r = $db->query("query","SELECT alm.*,acm.city_name FROM avn_centermanager_master alm INNER JOIN avn_city_master acm ON acm.unique_id = alm.city_id  ORDER BY " . mysql_escape_string($field) . " " . mysql_escape_string($sort) . " LIMIT " . $limitStart. ", " . $limitEnd);
	//print_r($r);
	...
	<?php
		...
		for($i = $start; $i < $end; $i++)
		{
			if($i == $curPage)
				...
				$nav .=    " <a href=\"javascript: void(0);\" onclick=\"javascript: _getManagerTable ($i, '$field', '$sort');\" class=\"paging\">$i</a>";
		}
		if($curPage > 5)
		{
			$page = $start - 5;
			$prev = " <a href=\"javascript:void(0);\" onclick=\"javascript: _getManagerTable ($page, '$field', '$sort');\" class=\"paging\">&lt;&lt;&nbsp;Previous</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		}
		if($noOfpage > 5 && $end <= $noOfpage)
		{
			$page = $start + 5;
			$next = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href=\"javascript:void(0);\" onclick=\"javascript: _getManagerTable ($page, '$field', '$sort');\" class=\"paging\">Next&nbsp;&gt;&gt;</a> ";
		}
	?>
...
</div><!-- end of assigning Center to manager pop-up -->