<?php
    ...
    $selectWhereClause = "";
    $pageParam="";
    $sql = "select count(unique_id) as 'total' from avn_question_master WHERE topic_id = " . $topicid . " and type = 1";
...
?>
    <table cellspacing="1" width="100%" id ="tabspotquestions" cellpadding="3" border="0" style="background-color:#f5f5f5;" class="mdata">
        ...
        <thead>
            <tr style="background-color:#a74242;color:#ffffff;">
                ...
                if($field == "qm.question_name"){
                    if($sort == "asc"){
        ?>
                        <th><a href="javascript:void(0);" onclick="javascript: _getSpotQesTable(<?php echo $currid; ?>,<?php echo $topicid; ?>,<?php echo $catgid; ?>,<?php echo $chptid; ?>, <?php echo $curPage; ?>, 'qm.question_name','desc');" class="sort">Question <img src="./images/up-arr.png" border="0" /></a></th>
        <?php
                    }else{
        ?>
                        <th><a href="javascript:void(0);" onclick="javascript: _getSpotQesTable(<?php echo $currid; ?>,<?php echo $topicid; ?>,<?php echo $catgid; ?>,<?php echo $chptid; ?>, <?php echo $curPage; ?>, 'qm.question_name','asc');" class="sort">Question <img src="./images/down-arr.png" border="0" /></a></th>
        <?php
                    }
                }else{
        ?>
                        <th><a href="javascript:void(0);" onclick="javascript: _getSpotQesTable(<?php echo $currid; ?>,<?php echo $topicid; ?>,<?php echo $catgid; ?>,<?php echo $chptid; ?>, <?php echo $curPage; ?>, 'qm.question_name','asc');" class="sort">Question</a></th>
        <?php
                }
                if($field == "qm.priority"){
                    if($sort == "asc"){
        ?>
                        <th><a href="javascript:void(0);" onclick="javascript: _getSpotQesTable(<?php echo $currid; ?>,<?php echo $topicid; ?>,<?php echo $catgid; ?>,<?php echo $chptid; ?>, <?php echo $curPage; ?>, 'qm.priority','desc');" class="sort">Priority <img src="./images/up-arr.png" border="0" /></a></th>
        <?php
                    }else{
        ?>
                        <th><a href="javascript:void(0);" onclick="javascript: _getSpotQesTable(<?php echo $currid; ?>,<?php echo $topicid; ?>,<?php echo $catgid; ?>,<?php echo $chptid; ?>, <?php echo $curPage; ?>, 'qm.priority','asc');" class="sort">Priority <img src="./images/down-arr.png" border="0" /></a></th>
        <?php
                    }
                }else{
        ?>
        ...
        <?php
                $r = $db->query("query","SELECT DISTINCT qm.*,rd.topic_id FROM avn_question_master qm INNER JOIN avn_resources_detail rd ON rd.topic_id = qm.topic_id WHERE qm.topic_id = " . $topicid . " AND qm.type = 1 AND rd.topic_id = " . $topicid . " ORDER BY " . mysql_escape_string($field) . " " . mysql_escape_string($sort) . " LIMIT ". $limitStart .", " . $limitEnd);
                ...
                <td>
                    ...
                    ?>
                            <a href="javascript:void(0);" style="display: none;">
                                <img src="./images/showmore-up.png" id="up" name="up" class="noborder" onclick="javascript: _setqnspriority(<?php echo $currid; ?>,<?php echo $catgid; ?>,<?php echo $chptid; ?>,<?php echo $r[$i]['unique_id']?>,this.id,<?php echo $topicid; ?>,'1',<?php echo $curPage; ?>);" class="fl" style="width: 14px;" />
                            </a>
                    <?php
                        }else{
                    ?>
                    ...
                    ?>
                            <a href="javascript:void(0);" style="display: none;">
                                <img src="./images/showmore.png" id="down" name="down" class="noborder" onclick="javascript: _setqnspriority(<?php echo $currid; ?>,<?php echo $catgid; ?>,<?php echo $chptid; ?>,<?php echo $r[$i]['unique_id']?>,this.id,<?php echo $topicid; ?>,'1',<?php echo $curPage; ?>);" class="fl" style="width: 14px;" />
                            </a>
                    <?php
                        }
                        else
            ...
            <?php
                ...
                { 
                    if($i == $curPage)
                        ...
                        $nav .=    " <a href=\"javascript:void(0);\" onclick=\"javascript: _getSpotQesTable($currid,$topicid, $catgid, $chptid,$i,'$field','$sort');\" class=\"paging\">$i</a>";
                }
                if($curPage > 5)
                {
                    $page = $start - 5;
                    $prev = " <a href=\"javascript:void(0);\" onclick=\"javascript: _getSpotQesTable($currid,$topicid, $catgid, $chptid,$page,'$field','$sort');\" class=\"paging\">&lt;&lt;&nbsp;Previous</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                }
                if($noOfpage > 5 && $end <= $noOfpage)
                {
                    $page = $start + 5;
                    $next = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href=\"javascript:void(0);\" onclick=\"javascript: _getSpotQesTable($currid,$topicid, $catgid, $chptid,$page,'$field','$sort');\" class=\"paging\">Next&nbsp;&gt;&gt;</a> ";
                }
            ?>
