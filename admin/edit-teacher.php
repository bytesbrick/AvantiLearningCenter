...
<?php
	...
	$r = $db->query("query","SELECT atm.*, AES_DECRYPT(alm.password, '" . ENCKEY . "') as PWD FROM avn_teacher_master atm INNER JOIN avn_login_master alm ON atm.unique_id = alm.user_ref_id WHERE atm.unique_id = " . $_GET["cid"]);	
?>
</head>
<body>
<div id="pageR">
	<div id="pageContainerR">
		<div id="wrapper">	
			...
			<div id="container2">
				<div class="about2"><a href="./teacher.php" class="clrmaroon fl">Teachers &raquo;</a>&nbsp;Edit Teacher</div><!-- End of about -->
				<div id="displayUser">
					<form method="post" name="form" enctype='multipart/form-data' id="form" action="./update-teacher.php" onsubmit="return _chkteacherDetails();">
						<input type="hidden" id="hdTeacherid" name="hdTeacherid" value="<?php echo $_GET["cid"]; ?>">
						...
						<table cellspacing="6" cellpadding="5" border="0" width="65%">
							...
							<tr>
								<td><input type="text" id="txtTeacherID" name="txtTeacherID" class="inputseacrh" readonly="true" value="<?php echo $r[0]["teacher_id"]; ?>" /></td>
								<td><input type="text" id="txtTeacherFName" name="txtTeacherFName" class="txtboxS" placeholder="First name" value="<?php echo $r[0]["fname"]; ?>" />&nbsp;<input type="text" id="txtTeacherLName" name="txtTeacherLName" class="txtboxS" placeholder="Last name" value="<?php echo $r[0]["lname"]; ?>" /></td>
							</tr>
							<tr>
