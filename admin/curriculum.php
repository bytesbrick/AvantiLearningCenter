...
<div id="page">
	<div id="pageContainer">
		<div id="wrapper">	
			...
			<div id="container">
				<div class="about">Curriculums </div><div class="act"><a href="add-curriculum.php">Add Curriculum</a><div id="bulkAct"><a href="javascript:void(0);" id="btnDel" onclick="javascript: _deleteCurriculum(-1,<?php echo $curPage; ?>);" class="ml5">Delete</a></div></div><!-- End of about -->
