...
<head>
<title>Avanti &raquo; Dashboard &raquo; Edit User</title>
<?php
...
<div id="pageR">
	<div id="pageContainerR">
		<div id="wrapper">	
			...
			<div id="container2">
				<div class="about2"><a href="./lead-users.php" class="clrmaroon fl">Users &raquo;</a>&nbsp;Edit User</div><!-- End of about -->
				<div id="displayUser">
					<?php
						if(isset($_GET["cid"]) && $_GET["cid"] != "")
							$r = $db->query("query","SELECT * FROM avn_login_master WHERE unique_id=" . $_GET["cid"]);
					?>
					<form method="post" id="form" action="./update-user.php" onsubmit="return _chkuserDetailsedit();">
						<input type="hidden" id="hdnuID" name="hdnuID" value="<?php echo $_GET['cid']; ?>"/>
						<input type="hidden" id="hdstringuser" name="hdstringuser" value="<?php echo filter_querystring($_SERVER["QUERY_STRING"], array("cid"), array("")); ?>"/>
						<table cellspacing="6" cellpadding="4" border="0" width="710px" align="left">
							...
							<tr>
								...
								<td>
									<select type="dropdown" id="ddlTypeUser" name="ddlTypeUser" class="dropdown">
										<!--<option value="none">Select One</option>-->
										<?php
											if(isset($r[0]['user_type']) && $r[0]['user_type'] == 'Manager'){
										?>
										...
										?>
										<?php
											if(isset($r[0]['user_type']) && $r[0]['user_type'] == 'Teacher'){
										?>
										...
										<?php
											...
											if(isset($r[0]['user_type']) && $r[0]['user_type'] == 'Student'){
										?>
							...
							<tr>
								<td><input type="submit" id="btnupdate" name="btnupdate" value="Update User" class="btnSIgn" />&nbsp;&nbsp;&nbsp;&nbsp;<input type="button"  value="Cancel" class="btnSIgn" /></td>
								<td></td>
							</tr>
						</table>
					</form>
