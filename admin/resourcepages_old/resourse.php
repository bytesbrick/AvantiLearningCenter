	...
	<div id="pageContainer">
		<div id="wrapper">	
			...
			<div id="container">
				...
				?>
				<div class="about">Resource &raquo; <a href="add-resourse.php">Add Resource</a></div><!-- End of about -->
				<div id="ErrMsg" style="margin:10px 0px 0px 15px !important;">
					...
					if($_GET["resp"] == "err")
						...
						echo "Please select the images";
					else if($_GET["resp"] == "up")
						echo "Resource edited successfully";
					else if($_GET["resp"] == "invEd")
						echo "This Resource Cant Not Be Save because this is Already exit";
					else if($_GET["resp"] == "invUp")
						echo "This Resource Cant Not Be Updated because this is Already exit";
				...
				<div id="displayUser" class="fl mt20 ml20">
					<table cellspacing="1" width="100%" cellpadding="3" border="0" style="background-color:#f5f5f5;">
						<tr style="background-color:#5077BE;color:#ffffff;">
							...
							<td style="width:100px;"><b>Entry Date</b></td>
							<td style="width:50px;"><b>Action</b></td>
						</tr>
					<?php
						$r = $db->query("query","select * from `ltf_resources_master` order by resource_title limit ".$limitStart.", ".$limitEnd);
					...
					<tr style="background-color:<?php echo $bg; ?>">
						<td><?php echo $srno; ?></td>
						<td style="height:25px;text-align:left;"><?php echo $r[$i]["resource_title"]; ?></td>
						<?php
							if($r[$i]["ractive"]==1){
						...
						<td style="width:100px !important;text-align:left;"><?php echo $r[$i]["entry_date"]; ?></td>
						<td style="height:25px;width:100px;">
							<a href="edit-resourse.php?cid=<?php echo $r[$i]["unique_id"]; ?>">Edit</a> | <a href="javascript:void(0);" style="color:#f00;margin:0px 5px 0px 0px;" onclick="javascript:_deleteresource(<?php echo $r[$i]['unique_id']?>)">Delete</a> | <a href="./spot-test.php?cid=<?php echo $r[$i]["unique_id"]; ?>">Spot/Concept-test</a>
						</td>
					</tr>
			<?php
								}
