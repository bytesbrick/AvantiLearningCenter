<div class="leftdiv">
	...
	<!-- <div class="level">
		...
		?>
			<div class="chkcontent">
				<input type="checkbox" id="chklevel-<?php echo $r[$i]["unique_id"]; ?>" class="check" name="chkcurriculum" onclick="javascript: _createFilterTopic('chkcurriculum', this.value, this.id,<?php echo $_GET['currID']; ?>,<?php echo $_GET['chpID']; ?>);" value="<?php echo $r[$i]["unique_id"]; ?>" <?php if($_GET['currID'] == $r[$i]["unique_id"]) echo "checked"; else echo ""; ?>/>
	...
	<div class="level">
		...
		?>
			<div class="chkcontent">
				<input type="checkbox" id="chklevel-<?php echo $r[$i]["ID"]; ?>" class="check" name="chkgrade" onclick="javascript: _createFilterTopic('chkgrade', this.value, this.id,<?php echo $_GET['currID']; ?>,<?php echo $_GET['chpID']; ?>);" value="<?php echo $r[$i]["ID"]; ?>">
