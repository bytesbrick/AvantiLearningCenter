<div class="leftdiv">
	...
	<a href="./chapter-list.php?currID=<?php echo $_GET['currID']; ?>" class="clearfilter" id="clrFilter" style="display:none">Clear Filters</a>
	<!--<div class="level">
		...
		?>
			<div class="chkcontent">
				<input type="checkbox" id="chklevel-<?php //echo $r[$i]["unique_id"]; ?>" class="check" name="chkcurriculum" onclick="javascript: _createFilter('chkcurriculum', this.value, this.id, <?php //echo $_GET['currID']; ?>);" value="<?php //echo $r[$i]["unique_id"]; ?>" <?php //if($_GET['currID'] == $r[$i]["unique_id"]) echo "checked"; else echo ""; ?>/>
	...
	<div class="level">
		...
		?>
		<div class="chkcontent">
			<input type="checkbox" id="chklevel-<?php echo $r[$i]["unique_id"]; ?>" class="check" name="chkcategory" onclick="javascript: _createFilter('chkcategory', this.value, this.id,<?php echo $_GET['currID']; ?>);" value="<?php echo $r[$i]["unique_id"]; ?>">
	...
	<div class="level">
		...
		?>
			<div class="chkcontent">
				<input type="checkbox" id="chklevel-<?php echo $r[$i]["ID"]; ?>" class="check" name="chkgrade" onclick="javascript: _createFilter('chkgrade', this.value, this.id,<?php echo $_GET['currID']; ?>);" value="<?php echo $r[$i]["ID"]; ?>">
