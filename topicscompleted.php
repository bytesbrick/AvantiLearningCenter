		...
		<div class="tabeldiv">
			...
			?>
                    ...
                    <div class="headingdiv">
                        <span class="updiv">
			    <div class="fl">
				<img src="<?php echo __WEBROOT__; ?>/images/completed-topics.png" width="50" class="fl" alt="Lesson Plan" title="Lesson Plan" border="0">
                                <span class="fl" style="margin: 13px 0 0 5px;">Completed Topics</span><div class="clb"></div>
			    </div>
                            <div class="clb"></div>
				...
				<div class="fl mt10">
					...
					<a href="javascript: void(0);" style="color: #666;" onclick="javascript: _complete(-1,0);">Mark Incomplete</a>&nbsp;|&nbsp;<a href="javascript: void(0);" style="color: #666;" onclick="javascript: _starred(-1,1);">Mark Starred</a>
				    </span>
				</div>
                            </div>
                        </span>
