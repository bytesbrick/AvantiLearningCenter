...
<title>Avanti Learning Centres | Curriculum</title>
<?php
...
<script language="javascript" type="text/javascript">
	...
	document.getElementById("nav-main").getElementsByTagName("li")[2].getElementsByTagName("a")[0].className = "activeitem";
</script>
</body>
</html>
