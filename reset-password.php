...
<body>
	...
	<div style="margin: 0 auto;width:975px;">
		<div class="logodiv">
		    <a href="<?php echo __WEBROOT__; ?>/"><img src="<?php echo __WEBROOT__;?>/images/Logo-Hindi-only.png" border="0" alt="Avanti" title="Avanti" /></a>
		</div>
    ...
    <div class="center">
	<div class="midcolumn" style="margin: 30px 0 0 0px;font-family:helvetica;">
							...
							?>
									...
									<div id="displayUser mt20">
										...
										<div class="chngepswrdfrm">
											...
											<form method="post" name="frmResetPassword" id="frmResetPassword" action="<?php echo __WEBROOT__; ?>/save-new-password.php" onsubmit="javascript:return _validateResetPassword();">
											...
											<div class="txtfield">
												...
												<div class="fl" style="margin-left: 23px;"><input type="password" name="txtNCPassword" id="txtNCPassword" class="textbox ht25 wd210" /></div>
											</div>
											<div class="clr"></div>
											<div class="fl mt40"><input type="submit" name="btnregist" id="btnregist" class="btnSIgn" value="Change Password" style="padding: 5px;cursor:pointer;">
											&nbsp; &nbsp;<a href="./resetpassword.php?ud=<?php echo $uid; ?>&tk=<?php echo $token; ?>"><input type="button" name="btnCancel" id="btnCancel"  value="Cancel" class="btnSIgn"  style="padding: 5px;cursor:pointer;" /></a></div>
											</form>
										</div>
									</div>
							<?php
